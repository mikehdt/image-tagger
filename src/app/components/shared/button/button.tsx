...
export type ButtonColor =
  ...
  | 'indigo'
  | 'stone';
export type ButtonSize = 'medium' | 'mediumWide' | 'large';
...
> = {
  slate: {
    ...
    togglePressed:
      'bg-slate-100 text-slate-800 shadow-slate-400 hover:bg-slate-200',
    ...
    ghostDisabled: 'border-slate-300/0 text-slate-200',
  },
  amber: {
    ...
    togglePressed:
      'bg-amber-100 text-amber-800 shadow-amber-400 hover:bg-amber-200',
    ...
    ghostDisabled: 'border-amber-300/0 text-amber-200',
  },
  rose: {
    ...
    togglePressed:
      'bg-rose-100 text-rose-800 shadow-rose-400 hover:bg-rose-200',
    ...
    ghostDisabled: 'border-rose-300/0 text-rose-200',
  },
  emerald: {
    ...
    togglePressed:
      'bg-emerald-100 text-emerald-800 shadow-emerald-400 hover:bg-emerald-200',
    ...
    ghostDisabled: 'border-emerald-300/0 text-emerald-200',
  },
  sky: {
    normal: 'border-sky-300 bg-sky-200 text-sky-800',
    hover: 'hover:bg-sky-100',
    pressed: 'bg-sky-300 border-sky-400 text-sky-800 hover:text-sky-600',
    togglePressed: 'bg-sky-100 text-sky-800 shadow-sky-400 hover:bg-sky-200',
    ...
    ghostDisabled: 'border-sky-300/0 text-sky-200',
  },
  indigo: {
    ...
    togglePressed:
      'bg-indigo-100 text-indigo-800 shadow-indigo-400 hover:bg-indigo-200',
    ...
    ghostDisabled: 'border-indigo-300/0 text-indigo-200',
  },
  stone: {
    ...
    togglePressed:
      'bg-stone-100 text-stone-800 shadow-stone-400 hover:bg-stone-200',
    ...
    ghostDisabled: 'border-stone-300/0 text-stone-200',
  },
};
...
export const Button = ({
  ...
  const baseStyle = {
    ...
    pressed: 'shadow-sm',
    togglePressed: 'border-white shadow-sm',
  ...
  if (disabled) {
    ...
    switch (variant) {
      ...
      default:
        styleClasses = `${baseStyle.normal} ${colorConfig.normal} ${colorConfig.hover}`;
        break;
    }
  }
