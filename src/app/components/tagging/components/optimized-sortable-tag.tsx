...
type OptimizedSortableTagProps = {
  id: string;
  tagName: string;
  fade: boolean;
...
const OptimizedSortableTagComponent = ({
  id,
  tagName,
  fade,
  nonInteractive,
...
export const OptimizedSortableTag = memo(OptimizedSortableTagComponent);
